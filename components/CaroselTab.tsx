  ...
  const slides = [
    {
      ...
      imageUrl: '/Images/tobias-a-muller-rOLKpojjbGM-unsplash.jpg',
    },
    {
      note: 'Starting from $18 per day',
      ...
      imageUrl: '/Images/marc-kleen-5unH6DaHQoc-unsplash.jpg',
    },
    {
      ...
      imageUrl: '/Images/jd-weiher-r_I6Y3eFrXE-unsplash.jpg',
    },
  ];
